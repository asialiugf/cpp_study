...
class MACD : public FutureBase<M, N...> {
   public:
    ...
    MACD() {
        std::cout << "macd constructor !!! -- :  " << M << std::endl;  // N
    ...
    void macd() { std::cout << "from macd(): " << M << " " << M << " " << this->o[this->index] << std::endl; };
...
class KDJ : public FutureBase<M, N...> {
   public:
    KDJ() {
        ...
        std::cout << "kdj  init !! ---- " << M << " " << M << std::endl;
    };
    void kdj() { std::cout << "from kdj(): " << M << " " << M << " " << this->o[this->index] << std::endl; };
};
