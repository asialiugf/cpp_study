...
void main3() {
    ...
    std::cout << "----------c: " << now1() - w << std::endl;

    w = now1();
    auto out = std::jthread([ h ] {
        for (int i = 0; i < 33000; ++i) {
            h();
        }
    });
    /*
    auto out1 = std::jthread([ h ] {
        for (int i = 33000; i < 66000; ++i) {
            h();
        }
    });
    auto out2 = std::jthread([ h ] {
        for (int i = 66000; i < 100000; ++i) {
            h();
        }
    });
    */
    ...
    // out1.join();
    // out2.join();
    std::cout << "------jthread ----c: " << now1() - w << std::endl;
    ...
    std::cout << "----------ddddd--- c: " << now1() - w << std::endl;
