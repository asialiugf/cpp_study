...
int main(int argc, char* argv[]) {
    ...
    boost::signals2::signal_type<
        void(), boost::signals2::keywords::mutex_type<boost::signals2::dummy_mutex>>::type bs;
    ...
    std::chrono::time_point<std::chrono::steady_clock> bb, ee;
    bb = std::chrono::steady_clock::now();
    ls();
    ee = std::chrono::steady_clock::now();
    std::cout << (ee - bb).count() << " ns -- ls\n";
    ...
    // normal
    std::cout << "\n normal performance:\n";
    elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(get_performance(kk));
    std::cout << elapsed.count() << " ns\n";

    // lsignal performance
    std::cout << "\nlsignal performance:\n";
    // elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(get_performance(ls));
